...
async function seed() {
  ...
  const [author1, author2, author3, author4, author5, author6, author7] = await Promise.all([
    ...
    Author.create({ name: 'J.R.R. Tolkien', bio: 'John Ronald Reuel Tolkien CBE FRSL was an English writer, poet, philologist, and academic, best known as the author of the high fantasy works The Hobbit and The Lord of the Rings. '}),
    Author.create({ name: 'George R.R. Martin', bio: 'George Raymond Richard Martin is the author of the series of epic fantasy novels A Song of Ice and Fire, which were adapted into the Emmy Award-winning HBO series Game of Thrones. '}),
    Author.create({ name: 'C.S. Lewis', bio: 'Clive Staples Lewis was a British writer and lay theologian. He held academic positions in English literature at both Oxford University and Cambridge University.' }),
    Author.create({ name: 'Shel Silverstein', bio: 'Sheldon Allan Silverstein was an American writer, poet, cartoonist, songwriter, and playwright. Born and raised in Chicago, Illinois, Silverstein briefly attended university before being drafted into the United States Army.'})
  ])
  ...
  const [book1, book2, book3, book4] = await Promise.all([
    ...
    Book.create({ name: 'A Game of Thrones: A Song of Ice and Fire', imageURL: 'https://images-na.ssl-images-amazon.com/images/I/51DGe0uFHCL._SX330_BO1,204,203,200_.jpg', description: "Winter is coming. Such is the stern motto of House Stark, the northernmost of the fiefdoms that owe allegiance to King Robert Baratheon in far-off King’s Landing.", inventory: 5, price: 15.49})
  ])
